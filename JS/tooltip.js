...
//----------------------------------------------------------------------------------------------------
	this.create = function() {
		...
		if(this.width) this.obj.style.width = this.width;
		...
		if(this.borderRadius) this.obj.style.borderRadius = this.borderRadius + 'px';
